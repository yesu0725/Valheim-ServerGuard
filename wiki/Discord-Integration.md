...
| Event | Example |
|---|---|
| Server boot | `🚀 ServerGuard online v2.0.0  enforce=ON  requireHmac=ON  req/allow/ban=1/29/0  modset=8ce8906e` |
...
| Moderator tried an unlisted dev command *(2.0)* | `🚫 **Erik (765…)** (moderator) tried dev command \`spawn\` — not in \`moderatorDevcommands\`` |
